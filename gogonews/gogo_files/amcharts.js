...
AmCharts.ValueAxis = AmCharts.Class({
    ...
    draw: function() {
        ...
        if (isNaN(this.min) || isNaN(this.max) ||
            ...
            this.exponential = !1;
            for (f = p; f <
                r; f += n) t = AmCharts.roundTo(this.step * f + this.min, u), -1 != String(t).indexOf("e") && (this.exponential = !0, String(t).split("e"));
    ...
    createSerialGraph: function() {
        ...
        for (J = ca; J <= oa; J++) {
            ...
            if (Aa) {
                ...
                if ("candlestick" == g || "ohlc" == g) V = Aa.close, vb =
                ...
                if (!wb && V < la ||
                    wb && V < sa) v.isNegative = !0, Ia && (Ha = Ia), Wa && (Ra = Wa), void 0 != Ba && (za = Ba);
                Xa = !1;
                ...
                switch (g) {
                    ...
                    case "smoothedLine":
                        if (isNaN(V)) z || (this.drawSmoothedGraph(x, t, P, Q), x = [], t = [], P = [], Q = []);
                            ...
                            if (Math.abs(F - gb) >= ib || Math.abs(E - hb) >= ib) x.push(F), t.push(E),
                                gb = F, hb = E;
                            xa = F;
                            ya = E;
                            fa = F;
                        ...
                        if (!isNaN(la) &&
                            ...
                            if (r) {
                                ...
                                var na = new AmCharts.Cuboid(e, L, ea,
                                        D, I, Ha, Ra, Y, ta, T, ha, u, r, aa, Za, jb, ma),
                                    Ab, Bb;
        ...
        if ("line" ==
            g || "step" == g || "smoothedLine" == g) "smoothedLine" == g ? this.drawSmoothedGraph(x, t, P, Q) : this.drawLineGraph(x, t, P, Q), S || this.launchAnimation();
...
AmCharts.ChartCursor = AmCharts.Class({
    ...
    detectMovement: function() {
        ...
        if (a.mouseIsOver) {
            var b = a.mouseX - this.x,
                c = a.mouseY - this.y; - .5 < b && b < this.width + 1 && 0 < c && c < this.height ? (this.drawing ? this.rolledOver || a.setMouseCursor("crosshair") : this.pan && (this.rolledOver || a.setMouseCursor("move")), this.rolledOver = !0, (this.valueLineEnabled || this.valueLineBalloonEnabled) && this.updateVLine(b, c), this.setPosition()) : this.rolledOver && (this.handleMouseOut(),
                this.rolledOver = !1)
    ...
    setPosition: function(a, b, c) {
        void 0 === b && (b = !0);
        if ("cursor" == this.type) {
            if (this.tempPosition = NaN, AmCharts.ifArray(this.data)) isNaN(a) && (a = this.getMousePosition()), (a != this.previousMousePosition || !0 === this.zoomed || this.oneBalloonOnly) && !isNaN(a) && ("mouse" == this.cursorPosition && (this.tempPosition =
                ...
                if (c.mouseIsOver || A || C || this.forceShow)
                    if (this.forceShow = !1, C) {
                        ...
                        0 !== e && (h = {
                            type: "zoomed",
                            target: this
                        }, h.chart = this.chart, g.parseDates && !g.equalSpacing ? (c + e > w && (e = w - c), A + e < t && (e = t - A), h.start =
                            ...
                            if (this.normalizeBulletSize(), this.destroyValueBalloons(), this.resizedBullets = [], B && this.valueBalloonsEnabled && z && c.balloon.enabled) {
                                ...
                                for (g = 0; g < B.length; g++)
                                    if (t = B[g], x = NaN, (!this.oneBalloonOnly || t == H) && t.showBalloon && !t.hidden && t.balloonText && ("step" == t.type && "left" == t.stepDirection && (r = this.data[a + 1]), r)) {
                                        if (w = r.axes[t.valueAxis.id].graphs[t.id]) x =
                                            w.y;
    ...
    handleMouseDown: function(a) {
        if (this.zoomable || this.pan || this.drawing) {
            var b = this.rotate,
                ...
                d = c.mouseX - this.x,
                e = c.mouseY - this.y;
            if (0 < d && d < this.width && 0 < e && e < this.height || "fake" == a) this.setPosition(), this.selectWithoutZooming && AmCharts.remove(this.selection), this.drawing ? (this.drawStartY = e, this.drawStartX = d, this.drawingNow = !0) : this.pan ? (this.zoomable = !1, c.setMouseCursor("move"), this.panning = !0, this.panClickPos = b ? e : d, this.panClickStart = this.start, this.panClickEnd = this.end, this.panClickStartTime =
...
AmCharts.AmSlicedChart = AmCharts.Class({
    ...
    construct: function(a) {
        ...
        this.colors = "#0C4CA3 #00ABE0 #D8DE3A #8EC649 #FBB04C #EE6AA6 #000000 #E6E6E6 #CCCCCC #B3B3B3 #999999 #606060 #3E3E3E".split(" ");
        this.alpha = 1;
        this.groupPercent = 0;
    ...
    pullSlice: function(a, b, c) {
        ...
        }, d, this.pullOutEffect) : c.translate(b *
            a.pullX, b * a.pullY));
...
AmCharts.AmLegend = AmCharts.Class({
    ...
    drawLegend: function() {
        ...
        this.titleWidth = 0;
        if (e = this.title) e = AmCharts.text(this.container, e, this.color, a.fontFamily, this.fontSize, "start", !0), AmCharts.setCN(a, e, "legend-title"), e.translate(this.marginLeft,
    ...
    createEntry: function(a) {
        if (!1 !== a.visibleInLegend) {
            ...
            if (this.useGraphSettings) {
                ...
                if ("line" == c || "step" == c || "smoothedLine" == c || "ohlc" == c) g = k.set(), a.hidden || (d = a.lineColorR, f = a.bulletBorderColorR), m = AmCharts.line(k, [0, 2 * l], [l / 2, l / 2], d, a.lineAlpha, a.lineThickness, a.dashLength), AmCharts.setCN(b, m, "graph-line"), g.push(m), a.bullet && (a.hidden || (d = a.bulletColorR), m = AmCharts.bullet(k, a.bullet,
